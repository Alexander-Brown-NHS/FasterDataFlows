...
## Change the value for $token to match the supplied token for APC_CURRENT

$filepath= "\\server\share\NHSEFDF\DATA_OUT\FDF_APC_CURRENT_v1_0.csv"
$outfile = "\\server\share\NHSEFDF\DATA_IN\FDF_API_RESPONSE\FDF_APC_CURRENT_v1_0_"
